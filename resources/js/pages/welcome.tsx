    ...
    const pricingPlans = [
        {
            name: 'Стартовий',
            price: 'Безкоштовно',
            features: ['5 проектів одночасно', 'Базові інструменти управління', 'Стандартна підтримка', 'Комісія 10%'],
            bestFor: 'Фрілансери та малі проекти',
        },
        {
            name: 'Професійний',
            price: '$29/міс',
            features: ['20 проектів одночасно', 'Розширені інструменти аналітики', 'Пріоритетна підтримка', 'Комісія 7%', 'Персональний менеджер'],
            bestFor: 'Професійні фрілансери та агенції',
        },
        {
            name: 'Бізнес',
            price: '$99/міс',
            features: ['Необмежена кількість проектів', 'API доступ', 'Експрес-підтримка 24/7', 'Комісія 5%', 'Додаткові інструменти колаборації'],
                        ...
                        <div className="flex h-[calc(100vh-120px)] items-center justify-center md:h-[calc(100vh-160px)]">
                            <div className="text-center">
                                ...
                                <p className="mx-auto mb-6 max-w-2xl text-base text-gray-600 md:mb-8 md:text-lg dark:text-gray-300">
                                    ...
                                    2018 року, допомогли реалізувати понад 8,500 успішних проектів.
                                </p>
                                {auth.user ? (
                                    <Link
                        ...
                        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
                            <div className="md:col-span-2">
                                ...
                                <p className="mb-4 text-sm text-gray-400 md:text-base">
                                    ...
                                    фахівців та 8,500 успішних проектів.
                                </p>
