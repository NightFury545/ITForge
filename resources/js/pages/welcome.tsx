...
export default function Welcome() {
    ...
    const categories = [
        ...
        { id: 'consulting', name: 'Аутсорсинг та консалтинг', image: '/images/consulting.jpg' },
        { id: 'translations', name: 'Переклади', image: '/images/translations.jpg' },
        { id: 'textwork', name: 'Робота з текстами', image: '/images/textwork.jpg' }
    ];
    ...
    {/* Головний блок */}
    <div className="flex-grow bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-6 text-[#1b1b18] dark:text-[#EDEDEC]">
    ...
    {/* Опис можливостей */}
    <div className="bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 p-6">
    ...
    <div className="bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-900 dark:to-gray-800 p-6">
    ...
    <div className="bg-gradient-to-br from-gray-300 to-gray-400 dark:from-gray-900 dark:to-gray-800 p-6">
        <section className="max-w-5xl mx-auto text-center">
